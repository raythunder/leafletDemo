...
/*Leaflet.TileLayer.ChinaProvider*/
L.TileLayer.ChinaProvider=L.TileLayer.extend({initialize:function(a,b){var c=L.TileLayer.ChinaProvider.providers,d=a.split("."),e=d[0],f=d[1],g=d[2],h=c[e][f][g];b.subdomains=c[e].Subdomains,L.TileLayer.prototype.initialize.call(this,h,b)}}),L.TileLayer.ChinaProvider.providers={TianDiTu:{Normal:{Map:"https://t{s}.tianditu.cn/DataServer?T=vec_w&X={x}&Y={y}&L={z}",Annotion:"https://t{s}.tianditu.cn/DataServer?T=cva_w&X={x}&Y={y}&L={z}"},Satellite:{Map:"https://t{s}.tianditu.cn/DataServer?T=img_w&X={x}&Y={y}&L={z}",Annotion:"https://t{s}.tianditu.cn/DataServer?T=cia_w&X={x}&Y={y}&L={z}"},Terrain:{Map:"https://t{s}.tianditu.cn/DataServer?T=ter_w&X={x}&Y={y}&L={z}",Annotion:"https://t{s}.tianditu.cn/DataServer?T=cta_w&X={x}&Y={y}&L={z}"},Subdomains:["0","1","2","3","4","5","6","7"]},Google:{Normal:{Map:"http://www.google.cn/maps/vt?lyrs=m@189&gl=cn&x={x}&y={y}&z={z}"},Satellite:{Map:"http://www.google.cn/maps/vt?lyrs=s@189&gl=cn&x={x}&y={y}&z={z}"},Subdomains:[]},MapABC:{Normal:{Map:"https://emap{s}.mapabc.com/mapabc/maptile?&x={x}&y={y}&z={z}"},Subdomains:["0","1","2","3"]},GaoDe:{Normal:{Map:"https://webrd0{s}.is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=8&x={x}&y={y}&z={z}"},Satellite:{Map:"https://webst0{s}.is.autonavi.com/appmaptile?style=6&x={x}&y={y}&z={z}",Annotion:"https://webst0{s}.is.autonavi.com/appmaptile?style=8&x={x}&y={y}&z={z}"},Subdomains:["1","2","3","4"]}},L.tileLayer.chinaProvider=function(a,b){return new L.TileLayer.ChinaProvider(a,b)};
